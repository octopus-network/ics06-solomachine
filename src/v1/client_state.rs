...
// use crate::prelude::*;
// use crate::v1::consensus_state::ConsensusState as SmConsensusState;
// use crate::v1::error::Error;
// use crate::v1::header::Header as SmHeader;
// use crate::v1::misbehaviour::Misbehaviour as SmMisbehaviour;
// use crate::v1::proof::types::sign_bytes::SignBytes;
// use crate::v1::proof::types::signature_and_data::SignatureAndData;
// // use crate::v1::proof::types::timestamped_signature_data::TimestampedSignatureData;
...
//         Self {
//             sequence,
//             frozen_sequence: if value.is_frozen { 0 } else { sequence },
